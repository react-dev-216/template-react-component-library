...
So for my project for example its: `npm install @react-dev-216/template-react-component-library`
...
```tsx
import React from "react";
import { Button } from "@react-dev-216/template-react-component-library";
